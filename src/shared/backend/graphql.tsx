        ...
        switchMap(headers =>
            ajax({
                ...
                catchError(err => {
                    ...
                    return requestGraphQL(ctx, request, variables, DEFAULT_SOURCEGRAPH_URL, retry, true, authError)
                })
            )
        )
    )
...
export function queryGraphQLNoRetry(
    ...
    return requestGraphQL(ctx, query, variables, url, false, useAccessToken) as Observable<QueryResult<IQuery>>
}
...
export function mutateGraphQLNoRetry(
    ...
    return requestGraphQL(ctx, mutation, variables, sourcegraphUrl, false, useAccessToken) as Observable<MutationResult>
}
